...
const hourInput = document.getElementById("hour-inputs");
const minuteInput = document.getElementById("minute-inputs");
const activeAlarm = document.querySelector(".alarm-list");
const setAlarm = document.getElementById("set");
const clearAllButton = document.querySelector(".clear");
const alarmSound = new Audio("./huawei-honor.mp3");
